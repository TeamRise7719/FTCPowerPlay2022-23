...
import org.firstinspires.ftc.teamcode.Qaqortoq.Subsystems.Sensing.SynchronousPID;
...
public class ThreadCommands2 implements Runnable {
    ...
    //11.11111111111% overshot
    private static final double P_DRIVE_COEFF = 1.0;    // Larger is more responsive, but also less stable
    ...
    public ThreadCommands2(HardwareMap hardwareMap, Telemetry tel, LinearOpMode opMode) {
